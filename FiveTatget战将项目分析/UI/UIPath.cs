...
//    public static UIPathData SkillInfo = new UIPathData("Prefab/UI/MySkillWindow", UIPathData.UIType.TYPE_MENUPOP);

//    //加载的左侧技能item
//    //public static UIPathData SkillRootButtonItem = new UIPathData("Prefab/UI/SkillRootButtonItem", UIPathData.UIType.TYPE_ITEM);
//    public static UIPathData SkillRootButtonItem = new UIPathData("Prefab/UI/MySkillRootButtonItem", UIPathData.UIType.TYPE_ITEM);
//    //右下方技能面板
...
//	public static UIPathData RewardRoot = new UIPathData("Prefab/UI/MyPanel", UIPathData.UIType.TYPE_POP, null, false, false);
...
//	public static UIPathData DivinationRoot = new UIPathData("Prefab/UI/MydivinationWindow", UIPathData.UIType.TYPE_POP,null,false,false);
...
//	//public static UIPathData BonusItemGetRoot = new UIPathData("Prefab/UI/MybonusGetWindow", UIPathData.UIType.TYPE_MENUPOP,null,false,false);
